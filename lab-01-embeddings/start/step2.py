"""
Step 2: Generate embeddings for multiple sentences and compute cosine similarity
between all pairs.
"""
...
def cosine_similarity(vec_a, vec_b):
    ...
    """
    # TODO: implement
    # Hint: cosine_similarity = dot(a, b) / (norm(a) * norm(b))
    # You can use math.sqrt and sum/zip, or import numpy.
    ...
