"""
Lab 06, Step 2: Context Formatting and Prompt Construction

Format retrieved chunks into a numbered context block with source attribution,
then build the full messages list for the LLM.
"""

# Sample data simulating retrieval results (use this for testing)
SAMPLE_CHUNKS = [
    {
...
def format_context(chunks):
    ...
    Each entry should look like:
        [1] (Source: KYC Policy Framework v2.1)
        Customer Identity Verification
        All customers must undergo identity verification ...

    Args:
        chunks: List of dicts with keys: content, heading, doc_title, score.

    Returns:
        A single formatted string with all chunks numbered.
    """
    # TODO: implement
    pass
...
def build_messages(query, chunks):
    ...
    The messages list should contain:
    1. A system message with SYSTEM_PROMPT.
    2. A user message that includes the formatted context followed by the query.

    The user message format should be:
        Context:
        <formatted_context>
