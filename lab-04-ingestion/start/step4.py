"""
Step 4: Bulk-load documents into the policy_documents table, then chunks with
embeddings into the policy_chunks table. Include JSONB metadata.
...
def insert_document(cursor, metadata):
    ...
    Args:
        cursor: A psycopg2 cursor object.
        metadata: A dict with document metadata.
    """
    # TODO: implement
    ...
...
def create_indexes(cursor):
    """Create HNSW index on the embedding column and GIN index on metadata.
